...
\-This function doesn't make any checking on {\itshape in\/}. \-It's the responsability of the programmer to load first the header in {\itshape img\/} and performs the appropriate checking. 
\end{DoxyWarning}
